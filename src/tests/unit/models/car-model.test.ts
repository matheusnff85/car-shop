...
import { carChangeMockWithId, carMock, carChangeMock, carMockWithId } from '../../mocks/carMock';
...
describe('Car Model', () => {
  ...
  describe('update a car', () => {
    it('succesfully updated', async () => {
      const carUpdated = await carModel.update('62cf1fc6498565d94eba52cd', carChangeMock);
